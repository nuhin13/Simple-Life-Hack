...
import com.nuhin13.com.SimpleLifeHack.model.PlaylistVideos;
...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.mTitleText.setTypeface(holder.mTitleText.getTypeface(), Typeface.BOLD);
        ...
        View.OnClickListener shareClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                sendIntent.putExtra(Intent.EXTRA_SUBJECT, "Watch \"" + videoSnippet.getTitle() + "\" on YouTube"+ " From Simple Life Hacking app");
